...
camera_url = 'http://77.120.165.2:8080/video'
...
def start_video_recording():
    ...
    video_writer = cv2.VideoWriter(video_filename, fourcc, 5.0, (640, 360))
    recording = True
